<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">StockEasy</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/StockEasy" class="hvr-grow">Home</a></li>
		        <li><a href="/StockEasy/about-stock-easy.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Stores</a></li>
		        <li><a href="foods.php" class="hvr-grow">Products</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-1800 102 1768. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/StockEasy">Home</a></li>
	        <li><a href="/StockEasy/about-stock-easy.php">About Us</a></li>
	        <li><a href="food-categories.php">Stores</a></li>
