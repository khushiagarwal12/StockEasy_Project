<div class="row">
			...
			<div class="col s2 left-sidebar" id="left-sidebar">
				...
				<div class="row">
					<div class="col">
						<h4 class="heading-name">StockEasy</h4>
					</div>
				</div>
				<ul class="nav nav-sidebar list-group">
				    <li class="list-group-item active"><a href="food-list.php">Products </a></li>
				    <li class="list-group-item"><a href="category-list.php">Stores</a></li>
